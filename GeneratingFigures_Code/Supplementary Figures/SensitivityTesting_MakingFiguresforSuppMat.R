...
#note: need to re-run k = 21 of the random scenario eventually, something weird happened to it.
...
for(k in 1:27){
  ...
  #plot histogram of network sizes for all 27 mean distances
  probs_touse <- which(connmat_reduced_threshold > round(probthresh/100,7)) #not sure if the rounding will work
  png(paste0("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/",avgdist,"km/HistogramofPresentdayNetworkSizes_avgdist",avgdist,"km.png"))
  hist(euclid_dist_threshold[probs_touse], main = paste0("Thresholded at ",probthresh,"%"), xlab = "Distances (km)")
  dev.off()

  g_orig <- graph.adjacency(as.matrix(connmat_reduced), weighted = TRUE)
  num_clust_presentday[k] <- clusters(g_orig, mode = "weak")$no
  if(k < 27){
    size_clust_presentday[[k]] <- clusters(g_orig, mode = "weak")$csize 
  }
}

library(vioplot)
vioplot(size_clust_presentday, xlab = "(avg dist threshold)/10", ylab = "Size of Networks")

#make one of those scatterplot/box plot things instead?

#how many present-day networks
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumberofPresentDayNetworks_10_260.png")
plot(x=seq(10,260,10), y = num_clust_presentday[1:26], xlab = "avg dist threshold", ylab = "Number of networks")
dev.off()
#ends around 15 networks

#240km
#num_clust_presentday[24] #15
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/240km/Initial_NetworkSizeHistogram.png")
hist(size_clust_presentday[[24]], xlab = "Size of Network", main = " ", breaks = 20)
dev.off()

#250km
#num_clust_presentday[25] #15
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/250km/Initial_NetworkSizeHistogram.png")
hist(size_clust_presentday[[25]], xlab = "Size of Network", main = " ", breaks = 20, cex.lab = 1.5)
dev.off()
...
png(paste0("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/PCentre_250km_Allreefs_customcolours.png"),width=20,height=20,units="cm",res=1500, pointsize=4) #res=1000
...
#size of networks (logged?)

#only want to include 20,40,60,etc
evenonly <- seq(2,24, by = 2)
oddonly <- seq(3,25,by=2)
#30% left plots #ADD 42KM TOO?
...
load("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/finalremovallists_norandom.RData")
load("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FullRandom_multiprob_removal.RData")
load("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FullRandom_sd_multiprob_removal.RData") #final_sd_sost_random_list, final_sd_nclo_random_list, final_sd_avgsizecluster_random_list, final_sd_avgnd_random_list
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumberofRemainingNetworks_10_260.png")
plot(x=seq(10,260,10), y = final_nclo_pcs, xlab = "avg dist threshold", ylab = "Number of networks", col = "#1d457f",pch=20, main = "Number of Networks in Remaining Reefs", xaxt = 'n', cex.lab = 1.5, cex.main = 1.5)
points(x=seq(10,260,10), y = final_nclo_rl, col = "#f9ad2a", pch = 20)
points(x=seq(10,260,10), y = final_nclo_random, col = "#cc5c76", pch = 20)
segments(x0 = seq(10,260,10), y0 = final_nclo_random-final_nclo_sd_random, y1 = final_nclo_random+final_nclo_sd_random, lwd = 2, lty = 1, col = "#cc5c76")
#legend("topright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
axis(side = 1, at = seq(10,260,10),labels = T)
...
#even only version
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumberofRemainingNetworks_evenonly.png")
plot(x=seq(20,240, by = 20), y = final_nclo_pcs[evenonly], xlab = "avg dist threshold", ylab = "Number of networks", col = "#1d457f",pch=20, main = "Number of Networks in Remaining Reefs", xaxt='n', cex.lab = 1.5, cex.main = 1.5)
points(x=seq(20,240, by = 20), y = final_nclo_rl[evenonly], col = "#f9ad2a", pch = 20)
points(x=seq(20,240, by = 20), y = final_nclo_random[evenonly], col = "#cc5c76", pch = 20)
segments(x0 = seq(20,240, by = 20), y0 = final_nclo_random[evenonly]-final_nclo_sd_random[evenonly], y1 = final_nclo_random[evenonly]+final_nclo_sd_random[evenonly], lwd = 2, lty = 1, col = "#cc5c76")
axis(side = 1, at = seq(20,240, by = 20),labels = T)
#legend("topright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
legend("topright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumberofRemainingNetworks_evenwithrealized.png")
plot(x=seq(20,240, by = 20), y = final_nclo_pcs[evenonly], xlab = "Mean Dispersal Distance Threshold", ylab = "Number of networks", col = "#1d457f",pch=20, main = "Number of Networks in Relict Reefs", xaxt='n', ylim = c(0,3000), cex.lab = 1.5, cex.main = 1.5)
...
final_nclo_random_realized <- final_nclo_random_list[[27]]
final_nclo_sd_random_realized <- final_sd_nclo_random_list[[27]]
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumberofRemainingNetworks_oddwithrealized.png")
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNetworkSize_10_260.png")
plot(x=seq(10,260,10), y = final_avgsizecluster_pcs, xlab = "avg dist threshold", ylab = "Geometric Mean Network Size", col = "#1d457f",pch=20, main = "Geometric Mean Network Size of Remaining Reefs", xaxt = 'n', cex.lab = 1.5, cex.main = 1.5)
points(x=seq(10,260,10), y = final_avgsizecluster_rl, col = "#f9ad2a", pch = 20)
points(x=seq(10,260,10), y = final_avgsizecluster_random, col = "#cc5c76", pch = 20)
segments(x0 = seq(10,260,10), y0 = final_avgsizecluster_random-final_avgsizecluster_sd_random, y1 = final_avgsizecluster_random+final_avgsizecluster_sd_random, lwd = 2, lty = 1, col = "#cc5c76")
#legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
axis(side = 1, at = seq(10,260,10),labels = T)
...
#even only version
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNetworkSize_evenonly.png")
plot(x=seq(20,240, by = 20), y = final_avgsizecluster_pcs[evenonly], xlab = "avg dist threshold", ylab = "GMean Network Size", col = "#1d457f",pch=20, main = "GMean Network Size of Remaining Reefs", xaxt = 'n')
points(x=seq(20,240, by = 20), y = final_avgsizecluster_rl[evenonly], col = "#f9ad2a", pch = 20)
points(x=seq(20,240, by = 20), y = final_avgsizecluster_random[evenonly], col = "#cc5c76", pch = 20)
segments(x0 = seq(20,240, by = 20), y0 = final_avgsizecluster_random[evenonly]-final_avgsizecluster_sd_random[evenonly], y1 = final_avgsizecluster_random[evenonly]+final_avgsizecluster_sd_random[evenonly], lwd = 2, lty = 1, col = "#cc5c76")
axis(side = 1, at = seq(20,240, by = 20),labels = T)
#legend("topright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNetworkSize_evenwithrealized.png")
plot(x=seq(20,240, by = 20), y = final_avgsizecluster_pcs[evenonly], xlab = "avg dist threshold", ylab = "GMean Network Size", col = "#1d457f",pch=20, main = "GMean Network Size of Relict Reefs", xaxt = 'n')
...
final_avgsizecluster_random_realized <- final_avgsizecluster_random_list[[27]]
final_avgsizecluster_sd_random_realized <- final_sd_avgsizecluster_random_list[[27]]
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNetworkSize_oddwithrealized.png")
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgSourceStrength_10_260.png")
plot(x=seq(10,260,10), y = final_avg_sost_pcs, xlab = "avg dist threshold", ylab = "Avg Source Strength", col = "#1d457f",pch=20, main = "Average Source Strength in Remaining Reefs", ylim = c(0,2300), xaxt = 'n')
points(x=seq(10,260,10), y = final_avg_sost_rl, col = "#f9ad2a", pch = 20)
points(x=seq(10,260,10), y = final_avg_sost_random, col = "#cc5c76", pch = 20)
segments(x0 = seq(10,260,10), y0 = final_avg_sost_random-final_avg_sost_sd_random, y1 = final_avg_sost_random+final_avg_sost_sd_random, lwd = 2, lty = 1, col = "#cc5c76")
#legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
axis(side = 1, at = seq(10,260,10),labels = T)
legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
#evenonly
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgSourceStrength_evenonly.png")
plot(x=seq(20,240,20), y = final_avg_sost_pcs[evenonly], xlab = "avg dist threshold", ylab = "Avg Source Strength", col = "#1d457f",pch=20, main = "Average Source Strength in Remaining Reefs", ylim = c(0,2300), xaxt = 'n')
points(x=seq(20,240,20), y = final_avg_sost_rl[evenonly], col = "#f9ad2a", pch = 20)
points(x=seq(20,240,20), y = final_avg_sost_random[evenonly], col = "#cc5c76", pch = 20)
segments(x0 = seq(20,240,20), y0 = final_avg_sost_random[evenonly]-final_avg_sost_sd_random[evenonly], y1 = final_avg_sost_random[evenonly]+final_avg_sost_sd_random[evenonly], lwd = 2, lty = 1, col = "#cc5c76")
#legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
axis(side = 1, at = seq(20,240, by = 20),labels = T)
legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgSourceStrength_evenwithrealized.png")
plot(x=seq(20,240,20), y = final_avg_sost_pcs[evenonly], xlab = "avg dist threshold", ylab = "Avg Source Strength", col = "#1d457f",pch=20, main = "Average Source Strength in Remaining Reefs", ylim = c(0,2300), xaxt = 'n')
...
final_avg_sost_random_realized <- final_avg_sost_random_list[[27]]
final_avg_sost_sd_random_realized <- final_sd_sost_random_list[[27]]
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgSourceStrength_oddwithrealized.png")
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNodeDegree_10_260.png")
plot(x=seq(10,260,10), y = final_avgnd_pcs, xlab = "avg dist threshold", ylab = "Avg Node Degree", col = "#1d457f",pch=20, main = "Average Node Degree in Remaining Reefs", xaxt = 'n')
points(x=seq(10,260,10), y = final_avgnd_rl, col = "#f9ad2a", pch = 20)
points(x=seq(10,260,10), y = final_avgnd_random, col = "#cc5c76", pch = 20)
segments(x0 = seq(10,260,10), y0 = final_avgnd_random-final_avgnd_sd_random, y1 = final_avgnd_random+final_avgnd_sd_random, lwd = 2, lty = 1, col = "#cc5c76")
#legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
axis(side = 1, at = seq(10,260,10),labels = T)
legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
#evenonly
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNodeDegree_evenonly.png")
plot(x=seq(20,240, by = 20), y = final_avgnd_pcs[evenonly], xlab = "avg dist threshold", ylab = "Avg Node Degree", col = "#1d457f",pch=20, main = "Average Node Degree in Remaining Reefs", xaxt = 'n')
points(x=seq(20,240, by = 20), y = final_avgnd_rl[evenonly], col = "#f9ad2a", pch = 20)
points(x=seq(20,240, by = 20), y = final_avgnd_random[evenonly], col = "#cc5c76", pch = 20)
segments(x0 = seq(20,240, by = 20), y0 = final_avgnd_random[evenonly]-final_avgnd_sd_random[evenonly], y1 = final_avgnd_random[evenonly]+final_avgnd_sd_random[evenonly], lwd = 2, lty = 1, col = "#cc5c76")
#legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
axis(side = 1, at = seq(20,240, by = 20),labels = T)
legend("topleft", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNodeDegree_evenwithrealized.png")
plot(x=seq(20,240, by = 20), y = final_avgnd_pcs[evenonly], xlab = "avg dist threshold", ylab = "Avg Node Degree", col = "#1d457f",pch=20, main = "Average Node Degree in Relict Reefs", xaxt = 'n')
...
final_avgnd_random_realized <- final_avgnd_random_list[[27]]
final_avgnd_sd_random_realized <- final_sd_avgnd_random_list[[27]]
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/AvgNodeDegree_oddwithrealized.png")
...
#final plot - putting the four together
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/Loss_sensitivitytesting_jointfigure.png", width = 1000, height = 1000)
par(mfrow = c(2,2))
...
load("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/AllReseedingresults_norandom.RData") #plateaupoint_pr_list etc
...
load("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FullRandom_multiprob_reseeding.RData")
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumReseeded_10_260.png")
plot(x=seq(10,260,10),y=(((numreseeded_pr_final + initialreefs)/12292)*100), xlab = "avg dist threshold", ylab = "%  of Reefs Reseeded", col = "#1d457f", pch = 20, ylim = c(20,100), xaxt = 'n')
points(x=seq(10,260,10),y=(((numreseeded_cr_final + initialreefs)/12292)*100),col = "#f9ad2a", pch = 20)
points(x=seq(10,260,10),y=(((numreseeded_rr_final + initialreefs)/12292)*100),col = "#cc5c76", pch = 20)
segments(x0 = seq(10,260,10), y0 = (((numreseeded_rr_lowerfinal + initialreefs)/12292)*100), y1 = (((numreseeded_rr_upperfinal + initialreefs)/12292)*100), lwd = 2, lty = 1, col = "#cc5c76")
axis(side = 1, at = seq(10,260, by = 10),labels = T)
...
#evenonly
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumReseeded_evenonly.png")
plot(x=seq(20,240, by = 20),y=(((numreseeded_pr_final[evenonly] + initialreefs)/12292)*100), xlab = "avg dist threshold", ylab = "%  of Reefs Reseeded", col = "#1d457f", pch = 20, ylim = c(20,100), xaxt = 'n')
points(x=seq(20,240, by = 20),y=(((numreseeded_cr_final[evenonly] + initialreefs)/12292)*100),col = "#f9ad2a", pch = 20)
points(x=seq(20,240, by = 20),y=(((numreseeded_rr_final[evenonly] + initialreefs)/12292)*100),col = "#cc5c76", pch = 20)
segments(x0 = seq(20,240, by = 20), y0 = (((numreseeded_rr_lowerfinal[evenonly] + initialreefs)/12292)*100), y1 = (((numreseeded_rr_upperfinal[evenonly] + initialreefs)/12292)*100), lwd = 2, lty = 1, col = "#cc5c76")
axis(side = 1, at = seq(20,240, by = 20),labels = T)
legend("bottomright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
#legend("bottomright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)", "Random Scenario"), col = c("#1d457f","#f9ad2a","#cc5c76","#e6b6c0"), lty = c(1,1,3,1), lwd = c(3,3,3,1))
dev.off()
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumReseeded_evenwithrealized.png")
plot(x=seq(20,240, by = 20),y=(((numreseeded_pr_final[evenonly] + initialreefs)/12292)*100), xlab = "avg dist threshold", ylab = "%  of Reefs Reseeded", col = "#1d457f", pch = 20, ylim = c(20,100), xaxt = 'n')
...
#odd with realized, need to run the code above for k = 27
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/NumReseeded_oddwithrealized.png")
...
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/PlateauPoint_Reseeding_10_260.png")
plot(x=seq(10,260,10),y=plateaupoint_pr, xlab = "avg dist threshold", ylab = "Plateau Point", col = "#1d457f", pch = 20, xaxt = 'n')
points(x=seq(10,260,10),y=plateaupoint_cr,col = "#f9ad2a", pch = 20,xaxt='n')
points(x=seq(10,260,10),y=plateaupoint_rr_mean,col = "#cc5c76", pch = 20)
segments(x0 = seq(10,260,10), y0 = plateaupoint_rr_lower, y1 = plateaupoint_rr_upper, lwd = 2, lty = 1, col = "#cc5c76")
axis(side = 1, at = seq(10,260, by = 10),labels = T)
legend("topright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()

#evenonly
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/PlateauPoint_Reseeding_evenonly.png")
plot(x=seq(20,240, by = 20),y=plateaupoint_pr[evenonly], xlab = "avg dist threshold", ylab = "Plateau Point", col = "#1d457f", pch = 20, ylim = c(0,45), xaxt = 'n')
points(x=seq(20,240, by = 20),y=plateaupoint_cr[evenonly],col = "#f9ad2a", pch = 20)
points(x=seq(20,240, by = 20),y=plateaupoint_rr_mean[evenonly],col = "#cc5c76", pch = 20)
segments(x0 = seq(20,240, by = 20), y0 = plateaupoint_rr_lower[evenonly], y1 = plateaupoint_rr_upper[evenonly], lwd = 2, lty = 1, col = "#cc5c76")
axis(side = 1, at = seq(20,240, by = 20),labels = T)
legend("topright", c("PCS Scenario", "Refuge-Loss Scenario","Mean(Random Scenario)"), col = c("#1d457f","#f9ad2a","#cc5c76"), lty = c(1,1,1), lwd = c(3,3,3))
dev.off()
...
#even with realized
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/PlateauPoint_Reseeding_evenwithrealized.png")
plot(x=seq(20,240, by = 20),y=plateaupoint_pr[evenonly], xlab = "avg dist threshold", ylab = "Plateau Point", col = "#1d457f", pch = 20, ylim = c(0,45), xaxt = 'n')
...
#odd with realized, need to run k = 27 code above first
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/PlateauPoint_Reseeding_oddwithrealized.png")
...
#Combined Figure
png("/Users/arielgreiner/GitHub/PhDThesisProjects/GlobalCoralConnectivityProject/SensitivityTesting/FinalGraphs/Re-seedingSensitivityFigure.png", width = 600, height = 1000)
par(mfrow = c(2,1))
